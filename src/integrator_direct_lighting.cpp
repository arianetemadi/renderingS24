...
Color3f DirectLightingIntegrator::Li(const Scene *scene, Sampler *sampler, const Ray3f &ray) const {
    ...
    }  // TODO: add one bounce in this case too?

    return Li_one_bounce(scene, sampler, ray, its);
}

Color3f DirectLightingIntegrator::Li_one_bounce(const Scene *scene, Sampler *sampler, const Ray3f &ray,
