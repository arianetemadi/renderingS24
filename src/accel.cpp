...
void Accel::testTriangle(const Mesh* mesh, uint32_t idx, Ray3f& ray, bool shadow, Intersection& its, bool& foundIntersection, uint32_t& f) const
{
	its.attempts++;
	float u, v, t;
...
bool Accel::rayIntersect(const Ray3f &ray_, Intersection &its, bool shadowRay) const {
	...
	for (const BVH& bvh : m_bvhs)
	{
		...
		*/
		...
		{
			testTriangle(mesh, idx, ray, shadowRay, its, foundIntersection, f);
